...
object FindFoodRequirement : PlayerRequirement {
    ...
    override fun weight(entity: Entity) = entity[MetabolismComponent::class].hunger

    override fun goal(entity: Entity) = GoalType.FIND_FOOD
}
